...
<style>
.alert.error{background:#fef2f2;border-left:4px solid #dc2626;color:#b91c1c;padding:12px 16px;border-radius:12px;margin-bottom:16px;font-size:14px;}
.lampiran-list{display:flex;flex-wrap:wrap;gap:10px;margin-top:8px;}
.lampiran-item{position:relative;display:inline-flex;align-items:center;gap:6px;background:#f8fafc;border:1px solid #e7eaf2;border-radius:10px;padding:7px 12px;font-size:13px;transition:background .15s ease;}
.lampiran-item:hover{background:#f1f4f9;}
...
.btn-hapus-foto{background:none;border:none;color:#dc2626;cursor:pointer;font-size:16px;line-height:1;padding:0 2px;flex-shrink:0;transition:transform .15s ease;}
.btn-hapus-foto:hover{color:#991b1b;transform:scale(1.15);}
.info-note{background:#eff6ff;border-left:4px solid #2563eb;color:#1e40af;padding:12px 16px;border-radius:12px;font-size:13px;margin-bottom:16px;}
</style>
</head><body>
