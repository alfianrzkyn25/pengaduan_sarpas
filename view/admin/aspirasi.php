...
<tr><td>#<?=$a['id_aspirasi']?></td><td><?=e($a['nis'])?></td><td><?=e($a['nama'])?></td><td><?=e($a['nama_kategori'])?></td><td><?=e($a['lokasi'])?></td><td><?=e($a['keterangan'])?></td><td><span class="badge <?=strtolower($a['status'])?>"><?=e($a['status'])?></span></td><td><?=e($a['feedback']?:'-')?></td><td><a class="btn" href="detail_aspirasi.php?id=<?=$a['id_aspirasi']?>">Beri Feedback</a></td></tr>
<?php endforeach;?>
</table></div></section>
</main></div>
</body></html>
