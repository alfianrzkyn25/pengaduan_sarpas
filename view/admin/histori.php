...
<style>
.btn-hapus{display:inline-flex;align-items:center;gap:4px;padding:5px 12px;font-size:12px;background:#fef2f2;color:#b91c1c;border:1px solid #fecaca;border-radius:8px;cursor:pointer;font-weight:600;transition:background .15s ease,transform .15s ease;}
.btn-hapus:hover{background:#fecaca;transform:translateY(-1px);}
.alert-success{background:#f0fdf4;border-left:4px solid #16a34a;color:#166534;padding:12px 16px;border-radius:12px;margin-bottom:16px;font-size:14px;}
.modal-overlay{display:none;position:fixed;inset:0;background:rgba(15,23,42,.5);backdrop-filter:blur(2px);z-index:999;align-items:center;justify-content:center;}
.modal-overlay.active{display:flex;}
.modal-box{background:#fff;border-radius:18px;padding:30px 32px;max-width:380px;width:90%;box-shadow:0 24px 48px -12px rgba(15,23,42,.35);text-align:center;animation:modalIn .22s cubic-bezier(.4,0,.2,1);}
...
.modal-box p{margin:0 0 20px;font-size:14px;color:#667085;}
.modal-actions{display:flex;gap:10px;justify-content:center;}
.modal-actions .btn-batal{padding:9px 20px;border:1.5px solid #e2e6ee;border-radius:10px;background:#fff;cursor:pointer;font-size:14px;font-weight:600;color:#374151;transition:background .15s ease;}
.modal-actions .btn-batal:hover{background:#f8fafc;}
.modal-actions .btn-konfirm{padding:9px 20px;border:none;border-radius:10px;background:linear-gradient(135deg,#ef4444,#b91c1c);color:#fff;cursor:pointer;font-size:14px;font-weight:700;box-shadow:0 8px 18px -8px rgba(220,38,38,.5);transition:transform .15s ease,filter .15s ease;}
