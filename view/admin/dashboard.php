        ...
        <main class="content-area">
            ...
            <section class="panel">
                <div class="panel-head">
                    <h2>5 Aspirasi Terbaru</h2><a href="../controller/c_aspirasi.php">Kelola semua</a>
                </div>
                    ...
                    <table class="table">
                        ...
                        <?php while ($a = mysqli_fetch_assoc($r)): ?>
                            <tr>
                                ...
                                <td><a class="btn" href="../controller/c_detail_aspirasi.php?id=<?= $a['id_aspirasi'] ?>">Beri Feedback</a></td>
                            </tr>
                        <?php endwhile; ?>
                    </table>
                </div>
